...
const Cart = () => {
  ...
  // FEATURE 4: Empty Cart View
  if (cart.length === 0) {
    return (
      <div className="container mx-auto px-4 py-24 text-center flex flex-col items-center justify-center min-h-[70vh]">
        <div className="bg-gray-900 p-8 rounded-full mb-6 shadow-2xl border border-gray-800 animate-pulse">
           <ShoppingCart className="w-16 h-16 text-gray-600" />
        </div>
        <h2 className="text-4xl font-extrabold text-white mb-4 tracking-tight">
          Your Vantix Cart is Empty
        </h2>
        <p className="text-gray-400 text-lg mb-10 max-w-md mx-auto leading-relaxed">
          Looks like you haven't added any high-performance gear to your collection yet. Start exploring our latest tech.
        </p>
        <Link
          to="/"
          className="px-10 py-4 bg-orange-600 text-white font-bold rounded-full hover:bg-orange-700 transition duration-300 shadow-lg shadow-orange-900/40 uppercase tracking-widest flex items-center space-x-2"
        >
  ...
  // Normal Cart View (Shown if items exist)
  return (
    <>
